...
public class FriendListAdapter extends BaseAdapter implements Filterable {
     ...
     * @param context friend list context
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.list_search, parent, false);
            holder = new ViewHolder();
            //holder.iconText = (TextView) view.findViewById(R.id.icon_text);
            holder.name = (TextView) view.findViewById(R.id.tv_list_search);
